    ...
    <div class="rsvp-form-modal bg-white p-xl-5 p-3 bg-white position-relative">
        ...
        <div class="rsvp-form-content">
            <form id="rsvp-form">
                ...
                <!-- Paso 4: WEDDING DAY - CEREMONY -->
                <div id="step-4" class="rsvp-form-step">
                    <h2 class="fs-lg-3 text-primary mb-2">WEDDING DAY - CEREMONY</h2>
                    <div class="rsvp-form-event-details">
                        ...
                        <p class="fs-6 text-black font-secondary mb-4">7:00 P.M.</p>
                    </div>
                ...
                <!-- Paso 5: WEDDING DAY - RECEPTION -->
                <div id="step-5" class="rsvp-form-step">
                    <h2 class="fs-lg-3 text-primary mb-2">WEDDING DAY - RECEPTION</h2>
                    <div class="rsvp-form-event-details">
                        <p class="fs-6 text-black font-secondary mb-1">May 24th, 2026</p>
                        <p class="fs-6 text-black font-secondary mb-1">Teatro Adolfo Mejía</p>
                        <p class="fs-6 text-black font-secondary mb-4">7:00 P.M.</p>
                    </div>
