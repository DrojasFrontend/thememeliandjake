...
function sendAdminEmail($guest_name, $guests, $allergies, $email) {
    ...
    $message .= '
        ...
        <div class="footer">
            ...
            <p>Meli & Jake\'s Wedding - May 24th, 2026 - Cartagena, Colombia</p>
        </div>
    </body>
    </html>';
    ...
    if ($declined_all) {
            ...
            <div class="container">
                ...
                <div class="footer">
                    ...
                    <div style="margin-top: 20px; padding-top: 20px; border-top: 1px solid rgba(255,255,255,0.3);">
                        <p style="font-size: 12px;">May 24th, 2026 • Cartagena de Indias, Colombia</p>
                    </div>
                </div>
            </div>
        </body>
        ...
        <body>
            ...
            <div class="content">
                ...
                <h2 style="text-align: center; color: #746448; margin-bottom: 25px;">📅 Event Details</h2>
                ...
                <div class="events-container">
                    ...
                    <div class="event">
                        <div class="event-title">🍸 SHABBAT</div>
                        <div class="event-details">
                            <strong>Date:</strong> May 22th, 2026<br>
                            <strong>Location:</strong> Casa 1537<br>
                            <strong>Time:</strong> 7:00 P.M.<br>
                            <strong>Dress Code:</strong> White Cocktail Chic Attire
                        </div>
                    </div>
                    
                    <div class="event">
                        <div class="event-title">🥐 WELCOME COCKTAIL</div>
                        <div class="event-details">
                            <strong>Date:</strong> May 23th, 2026<br>
                            <strong>Location:</strong> Terraza Centro de Convenciones <br>
                            <strong>Time:</strong> 6:00 P.M.<br>
                            <strong>Dress Code:</strong> Tropical Sunset Chic Attire
                        </div>
                    </div>
                </div>
